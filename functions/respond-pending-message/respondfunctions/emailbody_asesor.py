      ...
      .es-desk-hidden {{
        ...
        @media only screen and (max-width:600px) {{
            ...
            *[class="gmail-fix"] {{ display:none!important }}
            ...
            a.es-button, button.es-button {{ font-size:18px!important; padding:10px 20px 10px 20px!important; line-height:120%!important }}
            ...
            .es-text-6853, .es-text-6853 p, .es-text-6853 a, .es-text-6853 h1, .es-text-6853 h2, .es-text-6853 h3, .es-text-6853 h4, .es-text-6853 h5, .es-text-6853 h6, .es-text-6853 ul, .es-text-6853 ol, .es-text-6853 li, .es-text-6853 span, .es-text-6853 sup, .es-text-6853 sub, .es-text-6853 u, .es-text-6853 b, .es-text-6853 strong, .es-text-6853 em, .es-text-6853 i {{ font-size:18px!important }}
            .img-5001 {{ width:98px!important; height:auto!important }}
        }}      
          ...
          <tr>
            ...
            <table cellspacing="0" cellpadding="0" align="center" class="es-header" role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;width:100%;table-layout:fixed !important;background-color:transparent;background-repeat:repeat;background-position:center top">
              <tr>
                ...
                <table cellspacing="0" cellpadding="0" bgcolor="#ffffff" align="center" class="es-header-body" role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:#FFFFFF;width:600px">
                  <tr>
                    <td align="left" bgcolor="#ffffff" style="padding:20px;Margin:0;background-color:#ffffff" data-custom-paddings="true"><!--[if mso]><table style="width:560px" cellpadding="0" cellspacing="0"><tr><td style="width:93px" valign="top"><![endif]-->
                    ...
                    </table><!--[if mso]></td><td style="width:20px"></td><td style="width:447px" valign="top"><![endif]-->
            ...
            <table cellspacing="0" cellpadding="0" align="center" class="es-content" role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;width:100%;table-layout:fixed !important">
              <tr class="es-visible-simple-html-only">
                <td align="center" bgcolor="transparent" class="es-stripe-html" style="padding:0;Margin:0">
                <table cellpadding="0" cellspacing="0" bgcolor="#ffffff" align="center" class="es-content-body" role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:#FFFFFF;width:600px">
                  <tr>
                    <td align="left" data-custom-paddings="true" style="Margin:0;padding-top:15px;padding-right:20px;padding-bottom:15px;padding-left:20px">
                    <table cellpadding="0" cellspacing="0" role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                      <tr>
                        <td align="left" style="padding:0;Margin:0;width:560px">
                        <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                          <tr>
                            <td align="center" style="padding:0;Margin:0"><p align="left" style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">Estimado/a <strong>{asesor_name}</strong>,</p><p align="left" style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px"><br></p><p align="left" style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">Este es un recordatorio de que tiene un mensaje pendiente del cliente <strong>{client_name}</strong>. Por favor, revise los detalles a continuación:</p></td>
                          </tr>
                        </table></td>
                      </tr>
                    </table></td>
                          ...
                          <tr>
                            ...
                            <table cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                              <tr>
                                ...
                                <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                  <tr>
                                    <td align="left" style="padding:0;Margin:0;border-collapse:collapse;border-radius:10px"><a style="mso-line-height-rule:exactly;text-decoration:underline;color:#2CB543;font-size:14px;background-color:#f2f2f2" href=""></a>
                                    <table style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;width:100%;border-radius:10px;font-family:Verdana, sans-serif" role="presentation">
                                    <tr>
                                    <th style="border:1px solid #ccc;padding:8px;text-align:center">Cliente</th>
                                    <th style="border:1px solid #ccc;padding:8px;text-align:center">Cedula del Cliente</th>
                                    ...
                                    <td style="padding:8px;Margin:0;border:1px solid #ccc;text-align:center">{client_name}</td>
                                    <td style="padding:8px;Margin:0;border:1px solid #ccc;text-align:center">{client_identification}</td>
                                    <td style="padding:8px;Margin:0;border:1px solid #ccc;text-align:center">{message_date}</td>
                                    <td style="padding:8px;Margin:0;border:1px solid #ccc;text-align:center">Pendiente</td>
                                    </tr>
                                    </table></td>
                                  </tr>
                                </table></td>
                  ...
                  <tr>
                    ...
                    <table cellpadding="0" cellspacing="0" role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                      <tr>
                        ...
                        <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                          <tr>
                            <td align="left" style="padding:0;Margin:0"><p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">Por favor, revise esta conversación lo antes posible para garantizar una atención rápida y efectiva.</p></td>
                          </tr>
                        </table></td>
                      </tr>
                    </table></td>
            ...
            <table cellspacing="0" cellpadding="0" align="center" class="es-content" role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;width:100%;table-layout:fixed !important">
              <tr>
                ...
                <table cellpadding="0" cellspacing="0" bgcolor="#ffffff" align="center" class="es-content-body" role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:#FFFFFF;width:600px">
                  <tr>
                    <td align="left" data-custom-paddings="true" style="Margin:0;padding-right:20px;padding-left:20px;padding-top:10px;padding-bottom:10px">
                    <table cellpadding="0" cellspacing="0" role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                      <tr>
                        <td align="left" style="padding:0;Margin:0;width:560px">
                        <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
            ...
            <table cellspacing="0" cellpadding="0" align="center" class="es-content" role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;width:100%;table-layout:fixed !important">
              <tr>
                <td align="center" bgcolor="transparent" style="padding:0;Margin:0">
                <table cellpadding="0" cellspacing="0" bgcolor="#ffffff" align="center" class="es-content-body" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:separate;border-spacing:0px;background-color:#FFFFFF;width:600px" role="none">
                  <tr>
                    <td align="left" bgcolor="transparent" class="es-m-p30r" style="Margin:0;padding-top:20px;padding-right:45px;padding-bottom:20px;padding-left:30px;border-radius:1px;background-color:transparent" data-custom-paddings="true">
                    <table cellpadding="0" cellspacing="0" role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                      <tr>
